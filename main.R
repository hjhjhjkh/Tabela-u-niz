...
for(r in 1:50){ # 1:nrow(procitanXls) i 1:ncol(procitanXls) u opstem slucaju; ovde specificno menjam smer citanja tabele na pola niza pa zato tacan broj
  for (k in 1:10){ # 10:1 za negativne brojeve; 1:10 za pozitivne brojeve; voditi racuna u proveri i da negativna nula nema u (zato nema tacno 1000 nego 999 za razliku od tabele)
